...
uint16_t DRV8323_Init_Device(void)
{
	...
	Result = Drv8323_WriteCmd(Gate_Drive_HS, 0x300);
	GATE_HS_DATA.reg.IDRIVEP_HS = 15;
	GATE_HS_DATA.reg.IDRIVEN_HS = 15;
	Result = Drv8323_WriteCmd(Gate_Drive_HS, 0x3FF);
	...
	GATE_LS_DATA.reg.TDRIVE = 2;
	GATE_LS_DATA.reg.IDRIVEP_LS = 15;
	GATE_LS_DATA.reg.IDRIVEN_LS = 15;
	Result = Drv8323_WriteCmd(Gate_Drive_LS, GATE_LS_DATA.cmd);*/
